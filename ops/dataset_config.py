...
def return_somethingv2(modality):
    filename_categories = 'ss2/category.txt'
    if modality == 'RGB':
        root_data = ROOT_DATASET + 'ss2\\frame'
        filename_imglist_train = 'ss2\\train_videofolder.txt'
        filename_imglist_val = 'ss2\\val_videofolder.txt'
        prefix = '{:06d}.jpg'
    elif modality == 'Flow':
